...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(mGenre!=5) {
            ...
            mGenreRef1 = mDatabaseReference.child(Const.ContentsPATH).child(String.valueOf("1"));
            mGenreRef2 = mDatabaseReference.child(Const.ContentsPATH).child(String.valueOf("2"));
            mGenreRef3 = mDatabaseReference.child(Const.ContentsPATH).child(String.valueOf("3"));
            mGenreRef4 = mDatabaseReference.child(Const.ContentsPATH).child(String.valueOf("4"));
